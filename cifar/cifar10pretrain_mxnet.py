...
train_dataiter = mx.io.ImageRecordIter(
    shuffle=True,
    path_imgrec="/home/amit-pc/mxnet/example/cifar10/kernelCifar/CifarRecFiles/train500.rec",
    #mean_img="./mean.bin",
    rand_crop=True,
    rand_mirror=True,
    data_shape=(3, 28, 28),
...
test_dataiter = mx.io.ImageRecordIter(
    path_imgrec="/home/amit-pc/mxnet/example/cifar10/kernelCifar/CifarRecFiles/test1000.rec",
    #mean_img="./mean.bin",
    rand_crop=False,
    rand_mirror=False,
    data_shape=(3, 28, 28),
...
num_round =50
model_prefix = "cifar10_stage1_500tr"
model = mx.model.FeedForward(ctx=mx.gpu(), symbol=softmax, num_round=num_round,
                             learning_rate=0.002, momentum=0.9, wd=0.001,
